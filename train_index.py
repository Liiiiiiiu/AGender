...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 14:05:50 2021
...
from datafolder.folder_index import Train_Dataset
...
dataset_dict = {
    ...
    'agender_data_2021':'agender_data_2021',
    'data_sets' : 'data_sets'
}
...
parser.add_argument('--data-path', default='/media/ubuntu/7934b444-78b3-4e80-b232-9aa3383920e4/test/test_qt/person_attribute_index_version4/age_gender/', type=str, help='path to the dataset')
parser.add_argument('--dataset', default='data_sets', type=str, help='dataset: market, duke')
...
assert args.dataset in ['market', 'duke','attri_bot_cox','agender_data_2021','data_sets']
...
#criterion_bce = FocalLoss()
#criterion_ce = FocalLossCE()
    ...
    for epoch in range(1, num_epochs+1):
        ...
        for phase in ['train', 'val']:
            ...
            for count, (images, indices, labels, ids, cams, names) in enumerate(dataloaders[phase]):
                ...
                running_corrects += torch.sum(preds == labels.bool()).item() / num_label
                if count % 100 == 0:
                    if not args.use_id:
