...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 15:38:56 2021

@author: ubuntu
"""
import os
from datafolder.reiddataset_downloader import *
from datafolder.reid_dataset.import_DukeMTMC import *
import scipy.io
...
def import_DukeMTMCAttribute(dataset_dir):
    ...
    print('f_attribute:',f.keys())
    print(len(f['duke_attribute'][0][0]))
    test_attribute = {}
    train_attribute = {}
    ...
    for test_train in range(len(f['duke_attribute'][0][0])):
        ...
        print('!!!',type(f['duke_attribute'][0][0][test_train][0][0]))
...
if '__name__' == '__main()__':
    data_dir = '/home/ubuntu/project_image/Person-Attribute-Recognition-MarketDuke-master/dataset/DukeMTMC-reID/'
    import_DukeMTMCAttribute_binary(data_dir)
