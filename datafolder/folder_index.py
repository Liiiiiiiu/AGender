...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 13:56:35 2021
...
from .reid_dataset import attibute_age_data

class Train_Dataset(data.Dataset):

    def __init__(self, data_dir, dataset_name, transforms=None, train_val='train' ):
        train, query, gallery = attibute_age_data.import_Session_nodistractors(data_dir, dataset_name)
        if dataset_name == 'data_sets':
            train_attr, query_attr,test_attr, self.label = attibute_age_data.import_indexAttribute(data_dir,dataset_name)
        else:
